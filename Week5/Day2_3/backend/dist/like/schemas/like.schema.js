...
__decorate([
    (0, mongoose_1.Prop)({ type: mongoose_2.Schema.Types.ObjectId, ref: "Comment", required: true }),
    __metadata("design:type", String)
], Like.prototype, "commentId", void 0);
__decorate([
    (0, mongoose_1.Prop)({ default: true }),
    __metadata("design:type", Boolean)
], Like.prototype, "isActive", void 0);
exports.Like = Like = __decorate([
    (0, mongoose_1.Schema)({ timestamps: true })
], Like);
exports.LikeSchema = mongoose_1.SchemaFactory.createForClass(Like);
exports.LikeSchema.index({ userId: 1, commentId: 1 }, { unique: true });
