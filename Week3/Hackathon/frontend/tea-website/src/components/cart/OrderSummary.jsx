    ...
    <div className="sm:w-[455px] font-montserrat py-3">
      ...
      <div className="bg-[#F4F4F4] py-11 px-6 w-full">
        ...
        <Button
          ...
          className="bg-[#282828] text-white hover:bg-transparent border hover:text-[#282828] w-full mt-3"
        >
          Check out
        </Button>
      </div>
      ...
      <div className="bg-[#F4F4F4] py-11 px-6 w-full my-12">
        ...
        <div className="flex items-center justify-between w-full pb-2 pt-6">
          <img className="w-12 rounded-sm " src={visa} alt="Visa" />
          <span className="w-12 h-8 rounded-sm bg-black text-[8px] font-montserrat text-white text-wrap flex items-center justify-center">
            <img className="w-6 object-contain" src={maestro} alt="Maestro" />
          </span>
          <span className="w-12 h-8 rounded-sm bg-black text-[8px] font-montserrat text-white text-wrap flex items-center justify-center">
            <img className="w-6 object-contain" src={mastercard} alt="MasterCard" />
          </span>
          <span className="w-12 h-8 rounded-sm bg-black text-[8px] font-montserrat text-white text-wrap flex items-center justify-center">
            <img className="w-6 object-contain" src={ideal} alt="iDEAL" />
          </span>
          <span className="w-12 h-8 rounded-sm bg-black text-[8px] font-montserrat text-white text-wrap flex items-center justify-center text-center font-semibold">
            {" "}
            advace payment
          </span>
        </div>
...
//         {/* payment methods */}
//         <div className="flex items-center justify-between w-full pb-2 pt-6">
//           <img className="w-12 rounded-sm " src={visa || "/placeholder.svg"} alt="Visa" />
//           <span className="w-12 h-8 rounded-sm bg-black text-[8px] font-montserrat text-white text-wrap flex items-center justify-center">
//             <img className="w-6 object-contain" src={maestro || "/placeholder.svg"} alt="Maestro" />
//           </span>
//           <span className="w-12 h-8 rounded-sm bg-black text-[8px] font-montserrat text-white text-wrap flex items-center justify-center">
//             <img className="w-6 object-contain" src={mastercard || "/placeholder.svg"} alt="MasterCard" />
//           </span>
//           <span className="w-12 h-8 rounded-sm bg-black text-[8px] font-montserrat text-white text-wrap flex items-center justify-center">
//             <img className="w-6 object-contain" src={ideal || "/placeholder.svg"} alt="iDEAL" />
//           </span>
//           <span className="w-12 h-8 rounded-sm bg-black text-[8px] font-montserrat text-white text-wrap flex items-center justify-center text-center font-semibold">
//             {" "}
//             advace payment
